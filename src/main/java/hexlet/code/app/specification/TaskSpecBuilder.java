...
public class TaskSpecBuilder {
    ...
    private Specification<Task> withStatus(String status) {
        return (root, query, cb) -> {
            ...
            Join<Task, hexlet.code.app.model.TaskStatus> statusJoin = root.join("status", JoinType.INNER);
    ...
    private Specification<Task> withLabelId(Long labelId) {
        return (root, query, cb) -> {
            ...
            Join<Task, hexlet.code.app.model.Label> labelsJoin = root.join("labels", JoinType.INNER);
